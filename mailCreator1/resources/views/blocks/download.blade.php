	...
	<table width="100%" id="mainStructure"  border="0" cellspacing="0" cellpadding="0" style="background-color:{{$campaign->background}};">
	  ...
	  <tr>
	                      ...
	                      <table  border="0"  align="right" cellpadding="0" cellspacing="0"  class="container2" >
	                        ...
	                        <tr>
	                         ...
	                         <td valign="top" align="center"  >
	                          ...
	                          <table  border="0"  align="center" cellpadding="0" cellspacing="0" class="container" >
	                            <tr><td  colspan="6" align="center" valign="middle"  id="clear-padding" style="color:#ffffff;"> Síguenos en:</td></tr>
                                <tr>
                                    
                                  @if($campaign->facebook != '' && $campaign->facebook != null)
	                              <td   align="center" valign="middle"  id="clear-padding">
	                                <a href="https://www.facebook.com/{{$campaign->facebook}}"><img src="{{asset('img/icon-facebook.png')}}" width="23" alt="icon-facebook" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
	                              </td>
	                              @endif
	                              
	                              @if($campaign->twitter != '' && $campaign->twitter != null)
	                              <td  s align="center" valign="middle" id="clear-padding">
	                                <a href="https://twitter.com/{{$campaign->twitter}}"><img src="{{asset('img/icon-twitter.png')}}" width="23" alt="icon-twitter" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
	                              </td>
	                              @endif
	                              
	                              @if($campaign->linkedin != '' && $campaign->linkedin != null)
	                              <td    align="center" valign="middle"  id="clear-padding">
	                                <a href="https://www.linkedin.com/{{$campaign->linkedin}}"><img src="{{asset('img/icon-linkedIn.png')}}" width="23" alt="icon-linkedIn" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
	                              </td>
	                              @endif
	                              
	                              @if($campaign->youtube != '' && $campaign->youtube != null)
	                              <td   align="center" valign="middle"  id="clear-padding">
	                                <a href="https://www.youtube.com/{{$campaign->youtube}}"><img src="{{asset('img/icon-youtube.png')}}" width="23" alt="icon-instagram" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
	                              </td>
	                              @endif
	                              
	                              @if($campaign->instagram != '' && $campaign->instagram != null)
                                  <td   align="center" valign="middle"  id="clear-padding">
                                      <a href="https://www.instagram.com/{{$campaign->instagram}}"><img src="{{asset('img/icon-instagram.png')}}" width="23" alt="icon-instagram" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
                                  </td>
                                  @endif
                                  
                                  @if($campaign->tiktok != '' && $campaign->tiktok != null)
                                  <td   align="center" valign="middle"  id="clear-padding">
                                    <a href="https://www.tiktok.com/{{$campaign->tiktok}}"><img src="{{asset('img/icon-tiktok.png')}}" width="23" alt="icon-tiktok" style="max-width:23px;padding-right: 3px;" border="0" hspace="0" vspace="0"/></a>
                                  </td>
                                  @endif
	   ...
	   <!--END VIEW ONLINE AND ICON SOCAIL-->
	    ...
	    @if($campaign->logo != '' && $campaign->logo != null)
	  <tr>
	    <td valign="top">
	      <table width="100%"  align="center" border="0" cellspacing="0" cellpadding="0"   >
	                  ...
	                  <tr>
	                    <td valign="top" align="center" >
	                      ...
	                      <table  border="0"  align="center" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
	                        <tr><td colspan="6" style="color: #727272;text-align: center;font-size: 18px;padding-bottom: 10px;">S&iacute;guenos en:</td></tr>
                            <tr>
                                @if($campaign->facebook!='' && $campaign->facebook != null)
	                          <td   height="30" align="center" valign="middle"  class="clear-padding">
	                            <a href="https://www.facebook.com/{{$campaign->facebook}}" target="_blank">
	                              <img src="{{asset('img/icon-facebook-color.png')}}" width="25" alt="icon-facebook" style="max-width:25px;" border="0" hspace="0" vspace="0"/>
	                            </a>
	                          </td>
	                           @endif
	                          @if($campaign->twitter!='' && $campaign->twitter != null)
	                          <td  style="padding-left:5px; " height="30" align="center" valign="middle" class="clear-padding">
	                            <a href="https://twitter.com/{{$campaign->twitter}}" target="_blank">
	                              <img src="{{asset('img/icon-twitter-color.png')}}" width="25" alt="icon-twitter" style="max-width:25px;" border="0" hspace="0" vspace="0"/>
	                            </a>
	                          </td>
	                           @endif
	                          @if($campaign->linkedin!='' && $campaign->linkedin != null)
	                          <td  style="padding-left:5px;" height="30" align="center" valign="middle"  class="clear-padding">
	                            <a href="https://www.linkedin.com/{{$campaign->linkedin}}" target="_blank">
	                              <img src="{{asset('img/icon-linkedIn-color.png')}}" width="25" alt="icon-Linkedin" style="max-width:25px;" border="0" hspace="0" vspace="0"/>
	                            </a>
	                          </td>
	                           @endif
	                          @if($campaign->youtube!='' && $campaign->youtube != null)
	                          <td  style="padding-left:5px;" height="30" align="center" valign="middle"  class="clear-padding">
	                            <a href="https://www.youtube.com/{{$campaign->youtube}}" target="_blank">
	                              <img src="{{asset('img/icon-youtube-color.png')}}" width="25" alt="icon-youtube" style="max-width:25px;" border="0" hspace="0" vspace="0"/>
	                            </a>
	                          </td>
	                           @endif
                              <td  style="padding-left:5px;" height="30" align="center" valign="middle"  class="clear-padding">
                                @if($campaign->instagram!='' && $campaign->instagram != null)
                                    <a href="https://www.instagram.com/{{$campaign->instagram}}" target="_blank"><img src="{{asset('img/icon-instagram-color.png')}}" width="25" alt="icon-instagram" style="max-width:25px;" border="0" hspace="0" vspace="0"/></a>
                                @endif
	                          </td>
	                          @if($campaign->tiktok!='' && $campaign->tiktok != null)
	                          <td  style="padding-left:5px;" align="center" valign="middle"  id="clear-padding">
                                <a href="https://www.tiktok.com/{{$campaign->tiktok}}" target="_blank"><img src="{{asset('img/icon-tiktok-color.png')}}" width="25" alt="icon-tiktok" style="max-width:25px;" border="0" hspace="0" vspace="0"/></a>
                              </td>
                               @endif
                            </tr>
	                      </table>
